<template>
  <div class="text-justify text-base text-black dark:text-white md:pl-48 md:pt-4">
    ...
    <p>
      At Bich Bui Photos, accessible from bichbui.com, one of our main priorities is the privacy of our visitors. This
      Privacy Policy document contains types of information that is collected and recorded by Bich Bui Photos and how we
      use it.
    </p>
